...
public  void cargarDatos(String where){
     try {
            ...
            ResultSet datos=conexion.ejecutarSQLSelect("select Nombres,cedula,telefono from personas inner join telefono on idpersonas=personas_idpersonas  "+ where);
            ...
            while(datos.next()){
                ...
                modelo.addRow(new Object[]{datos.getString("nombres"),datos.getString("cedula"),datos.getString("telefono")});
...
// TODO add your handling code here:
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 96, 681, 480));

        jLabel1.setText("Buscar");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(249, 36, -1, -1));
        ...
        getContentPane().add(buscatxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(329, 31, 129, 40));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 30, 50, -1));
